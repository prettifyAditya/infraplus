        ...
        <div className="header-wrapper">
            <div className="colA">
                <Link href="/" className="logo">
                    <img src="/assets/logo.svg" alt="Infraplus logo"></img>
                </Link>
            </div>
            <div className="colB">
                <ul className="nav-a">
                    <li className="hasDropdown">
                        <a href="#" aria-haspopup="true" aria-expanded="false">Sectors</a>
            ...
            <div className="colC">
                <ul className="nav-b">
                    ...
                    <li><Link href="telto: +91 98106 32693"> +91 98106 32693</Link></li>
                    <li>
