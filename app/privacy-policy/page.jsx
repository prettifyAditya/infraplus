            ...
            <div className="container">
                <div className="website-content">
                    <h1>Privacy Policy</h1>
                        <h3>Introduction</h3>
                        <p>When you interact with Infraplus Consulting, we may collect the following types of personal information:</p>
                        <ul>
                        ...
                        <p>Infraplus Consulting uses the collected information for various purposes, including:</p>
                        <ul>
