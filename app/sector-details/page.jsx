                    ...
                    <div className="banner-wrapper">
                        <div className="container">
                            <div className="heading" data-animate="fade-up">
                                ...
                                <p>Infraplus provides comprehensive services in the water, wastewater and water-related environmental sectors with services from planning, detailed design, project management to operation & maintenance.</p>
                            </div>
