    ...
    return(
        <main>
            <BannerWrapper
                ...
                mediaType="image"
                mediaSrc="/assets/images/banner/blogDetail-banner.jpg"
                bannerPosition="left"
                title="21 March, 2025"
                ...
                <div className="sector-detailA blog-detailsA sec-pad">
                    <div className="container flex over-hidden">
                        ...
                        <div className="colB" data-animate="fade-left">
                            ...
                            <h3>Services</h3>
                            <ul>
                                <li><Link href="#"><Image src="/assets/icon/planning.svg" width={20} height={20} />Planning</Link></li>
                                <li><Link href="#"><Image src="/assets/icon/design.svg" width={20} height={20} /> Design</Link></li>
                                <li><Link href="#"><Image src="/assets/icon/project.svg" width={20} height={20} />Project Management</Link></li>
                            </ul>
                        </div>
                    </div>
                </div>
